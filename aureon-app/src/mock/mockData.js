...
export const mockProjects = [
  {
    id: "PROJ-101",
    name: "Aureon Core API Gateway",
    manager: "Gayathri Ramesh",
    status: "Active",
    priority: "Urgent",
    progress: 78,
    health: 96,
    ...
    reposCount: 3,
    members: [
      { name: "Gayathri Ramesh", avatar: "GR" },
      { name: "David Vance", avatar: "DV" },
      { name: "Sarah Chen", avatar: "SC" }
    ],
  },
  {
    id: "PROJ-102",
    name: "Cloud Telemetry Mesh",
    manager: "David Vance",
    status: "Active",
    priority: "High",
    progress: 92,
  ...
  {
    id: "PROJ-104",
    name: "Static Code Analysis Engine",
    manager: "Alex Rivera",
    status: "In Progress",
    priority: "High",
    progress: 64,
