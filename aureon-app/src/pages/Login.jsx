...
export const Login = ({ onNavigateHome }) => {
  ...
  // Login State
  const [email, setEmail] = useState('admin@aureon.com');
  const [password, setPassword] = useState('Aureon@123');
  ...
  const demoAccounts = [
    { email: 'admin@aureon.com', role: 'ROLE_ADMIN', label: 'System Admin (CTO)', icon: Shield, color: 'bg-purple-600' },
