...
export const PmDashboard = ({ onNavigate }) => {
  ...
  const widgets = [
    { label: 'Projects', value: '5 Projects', sub: 'Database synchronized', icon: FolderKanban, color: 'border-l-blue-500' },
    { label: 'Active Sprints', value: '3 Running', sub: 'Sprints active', icon: Layers, color: 'border-l-indigo-500' },
    { label: 'Assigned Tasks', value: '12 Tasks', sub: 'In progress', icon: CheckSquare, color: 'border-l-emerald-500' },
    { label: 'Project Health', value: '94.5%', icon: Cpu, sub: 'Workspace Operational', color: 'border-l-emerald-600' },
