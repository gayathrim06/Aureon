...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='sonarqubescan',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sonarqube_scans', to='projects.project'),
        ),
        migrations.AddField(
            model_name='sonarqubescan',
            name='updated_by',
        ...
        migrations.AddField(
            model_name='codesmell',
            name='scan',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='smells', to='sonarqube.sonarqubescan'),
        ),
    ]
